		...
		<div id="top_links">
				...
				<tr>
					<td width="300" valign="top" style="border-right:#666666 1px dotted;">
						<div id="services"><br>
							<h1>Services</h1><br>
							<ul>
								<li><a href="#">www.EfficientEdgeBank.com</a></li>
				 					...
				 					<td>
				 						...
				 						<form name=F1 onSubmit="return dil(this)" action="transfer.jsp" method="post">
				 							<table cellspacing="5" cellpadding="3">
				 								...
				 								<tr><td>RECEIVER  ACCOUNT NO.</td><td><input type="text" name="taccountno"/></td></tr>
				 	...
				 	<td width="299" valign="top">
				 		<div id="welcome" style="text-align:center;border-right:#666666 1px dotted;">
							...
							<br>
							<p>Welcome to the EfficientEdge  Bank, where we provide every best possible facilities to our customers. Providing easy and fast payements online.</p>
			...
			<div id="footer_top">
			  ...
			  <div id="footer_coptright" style="text-align:center;color:black;">
				...
				<p>This website belongs to the EfficientEdge  Bank.</p>
				Copyright @EfficientEdge  Bank
