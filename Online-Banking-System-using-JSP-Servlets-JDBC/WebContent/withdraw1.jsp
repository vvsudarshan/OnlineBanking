					...
					<td width="300" valign="top" style="border-right:#666666 1px dotted;">
				 	...
				 	<td width="299" valign="top">
				 		<div id="welcome" style="text-align:center;border-right:#666666 1px dotted;">
							...
							<br>
							<p>Welcome to the EfficientEdge  Online Banking, where we provide every best possible facilities to our customers. Providing easy and fast payements online.</p>
